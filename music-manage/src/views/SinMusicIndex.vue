<template>
  <div class="info">
    <div class="left">
      ...
      <el-button size="middle" type="primary" @click="dialogFormVisible = true"
        >上传歌曲</el-button
      >
      <el-dialog title="添加歌曲" :visible.sync="dialogFormVisible">
        <el-form :model="form">
          ...
          >
            <el-button size="middle" type="primary" style="margin-left: 300px"
              >点击上传歌曲</el-button
            >
          </el-upload>
        </el-form>
